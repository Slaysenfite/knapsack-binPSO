...
public class TestUtility {
    ...
    public static int maxFitnessOfGeneration(Swarm population){
    ...
    public static double meanFitnessOfGeneration(Swarm population){
        double sum = 0.0;
        for(Particle i : population.getPopulation()){
            sum += i.getFitness();
        }
